...
<h2 style="color:#00a651" class="title"> Add User </h2>
<?php
        echo '<div class="row">';
    ...
    <div class="panel panel-default">
      <div class="panel-heading">Add A User</div>
        <div class="panel-body">
          <form class="form-horizontal" role="form" method="post" action="<?php echo base_url();?>user_authentication/add_new_user">
           ...
           <div class="form-group">
            <label class="col-lg-3 control-label" for="inputUser">Username:</label>
              <div class="col-lg-9">
                <input type="text" class="form-control" id="inputUser" name="username" placeholder="Enter Nickname" required />
              </div>
          </div>
